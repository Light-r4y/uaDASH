...
lv_obj_t* ui_LabelMapMax = NULL;
lv_obj_t* ui_LabelMapT0 = NULL;
lv_obj_t* ui_LabelMapMid = NULL;
lv_obj_t* ui_LabelMapT2 = NULL;
lv_obj_t* ui_LabelMapMin = NULL;
...
void ui_mainScreen_screen_init(void) {
  ...
  lv_bar_set_mode(ui_mapBar0, LV_BAR_MODE_SYMMETRICAL);
  ...
  lv_obj_set_style_text_opa(ui_LabelMapMax, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(ui_LabelMapMax, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_LabelMapT0, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_LabelMapT0, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(ui_LabelMapT0, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_opa(ui_LabelMapMid, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(ui_LabelMapMid, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_LabelMapT2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_LabelMapT2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(ui_LabelMapT2, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_LabelMapT2, &ui_font_FontIndicatorLabel, LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_opa(ui_LabelMapMin, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_LabelMapMin, &ui_font_FontIndicatorLabel, LV_PART_MAIN | LV_STATE_DEFAULT);
