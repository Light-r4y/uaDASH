...
lv_obj_t * ui_EngSetup = NULL;
lv_obj_t * ui_labelEngSetup = NULL;
// event funtions
...
void ui_event_EngSetup(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);

    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_engineConfigScreen, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_engineConfigScreen_screen_init);
        _ui_screen_delete(&ui_benchScreen);
...
void ui_benchScreen_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_EngSetup, lv_color_hex(0xE0FF00), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_EngSetup, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_labelEngSetup = lv_label_create(ui_EngSetup);
    lv_obj_set_width(ui_labelEngSetup, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_labelEngSetup, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_labelEngSetup, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labelEngSetup, "Engine\nconfig");
    lv_obj_set_style_text_color(ui_labelEngSetup, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_labelEngSetup, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_labelEngSetup, &ui_font_FontLabel, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_event_cb(ui_EngSetup, ui_event_EngSetup, LV_EVENT_ALL, NULL);
