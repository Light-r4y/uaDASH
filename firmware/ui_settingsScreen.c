...
void ui_event_turboSwitch(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void ui_settingsScreen_screen_init(void)
{
    ...
    ui_Label88 = lv_label_create(ui_oilPWarnButtonPlus);
    ...
    lv_obj_set_style_bg_opa(ui_turboSwitch, 255, LV_PART_INDICATOR | LV_STATE_CHECKED);

    lv_obj_set_style_bg_color(ui_turboSwitch, lv_color_hex(0x313131), LV_PART_KNOB | LV_STATE_CHECKED);
    ...
    lv_obj_add_event_cb(ui_turboSwitch, ui_event_turboSwitch, LV_EVENT_ALL, NULL);
}
